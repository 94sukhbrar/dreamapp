...
const ProfileScreen = ({navigation}) => {
  ...
  const [showReEnterPasswordPopup, setShowReEnterPasswordPopup] = useState(
    false,
  );
  ...
  const showImagePicker = async () => {
    ...
    ImagePicker.showImagePicker(
      {...imagePickerOptions, title: UIText[language].selectAvatar},
      async response => {
      ...
      <CustomKeyboardAvoidingView
        ...
        <View style={styles.container}>
          <ProfileHeader>
            ...
            <NavigationHeader
              title={UIText[language].myAccount}
          ...
          <View style={styles.accountDetailsTitleContainer}>
            <Text
              style={[
                styles.accountDetailsTitleText,
          ...
          <EditableTextField
            ...
            value={email}
            onApplyChange={applyChange}
            onBottomOffsetDetermined={bottomOffset =>
              setViewBottomOffset(bottomOffset)
            }
          />
